...
from utils.dc_utils import epoch
...
def main():
    ...
    #parser.add_argument('--lambda_oe', type=float, default=0.0, help='oe loss weight')
    ...
    args.save_path = 'result-model-synthetic-no-oe'
    ...
    for model_eval in model_eval_pool:
        ...
        for it_eval in range(args.num_eval):
            ...
            for ep in range(Epoch + 1):
                loss_train, acc_train = epoch('train', trainloader, net_eval, optimizer, criterion, args, aug=True)
